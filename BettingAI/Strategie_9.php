...
function SpelerEenBeurtNul9_1($RandomGetal) {
    if($RandomGetal == 5) {
        return -1;
    }else{
...
function SpelerTweeBeurtNul9_1($RandomGetal,$InzetSpelerEenBeurtNul) {
...
function SpelerEenBeurtEen9_1($RandomGetal,$Hand,$InzetSpelerEenBeurtNul,$InzetSpelerTweeBeurtNul) {
    if($Hand >= 4) {
...
function SpelerTweeBeurtEen9_1($RandomGetal,$Hand,$InzetSpelerEenBeurtNul,$InzetSpelerTweeBeurtNul,$InzetSpelerEenBeurtEen) {
...
function SpelerEenBeurtTwee9_1($RandomGetal,$Hand,$InzetSpelerEenBeurtNul,$InzetSpelerTweeBeurtNul,$InzetSpelerEenBeurtEen,$InzetSpelerTweeBeurtEen){
    return 0;
} 